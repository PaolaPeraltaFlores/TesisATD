...
imagen_recortada[np.where(mascara_azul == 255)] = [0, 0, 0]

# Crear una imagen en blanco del mismo tamaño que la imagen original
imagen_fondo_blanco = np.ones_like(imagen) * 0
...
cv2.imwrite('recorsab.jpg', imagen_recortada_final)
